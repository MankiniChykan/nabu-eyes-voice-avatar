 ...
 */class at extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let n=i._$litPart$;if(void 0===n){const t=s?.renderBefore??null;i._$litPart$=n=new Y(e.insertBefore(M(),t),t,void 0,s??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}at._$litElement$=!0,at.finalized=!0,nt.litElementHydrateSupport?.({LitElement:at});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:at}),(nt.litElementVersions??=[]).push("4.2.1");const ot={"nabu_playing_dash.gif":"Nabu Playing","nabu_equalizer_dash.gif":"Nabu Equalizer","nabu_equalizer_2_dash.gif":"Nabu Equalizer 2"},lt={"nabu_equalizer_dash.gif":"Nabu Equalizer","nabu_equalizer_2_dash.gif":"Nabu Equalizer 2","1px_equalizer_dash.gif":"1px Equalizer","1px_equalizer_fader_dash.gif":"1px Equalizer Fader","1px_equalizer_fader_2_dash.gif":"1px Equalizer Fader 2","2px_equalizer_dash.gif":"2px Equalizer","2px_equalizer_fader_dash.gif":"2px Equalizer Fader","2px_equalizer_fader_2_dash.gif":"2px Equalizer Fader 2","2px_equalizer_bottom_dash.gif":"2px Bottom Equalizer","nabu_music_dash.gif":"Nabu Music"},ht=["on","detected","unavailable"];var ct,dt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ct||(ct={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(dt||(dt={}));class _t extends at{setConfig(t){this._config={...t,assist_entities:[...t.assist_entities??[]],countdown_events:[...t.countdown_events??[]],countdown_clear_events:[...t.countdown_clear_events??[]],alarm_events:[...t.alarm_events??[]],alarm_clear_events:[...t.alarm_clear_events??[]],alarm_entities:[...t.alarm_entities??[]],alarm_active_states:[...t.alarm_active_states??ht]}}render(){if(!this.hass||!this._config)return D``;const t=this._config;return D`
      <div class="form">
        ...
        >
          ${Object.entries(ot).map(([t,e])=>D`<mwc-list-item .value=${t}>${e}</mwc-list-item>`)}
        </ha-select>
        ...
        <ha-textfield
          ...
          .value=${(t.alarm_active_states??ht).join(", ")}
    ...
    `}}_t.properties={hass:{attribute:!1},_config:{state:!0}},customElements.get("nabu-eyes-dashboard-card-editor")||customElements.define("nabu-eyes-dashboard-card-editor",_t);const ut={idle:"nabu_idle_preview_dash.gif",listening:"nabu_listening_dash.gif",processing:"nabu_processing_dash.gif",responding:"nabu_responding_dash.gif",playing:"nabu_playing_dash.gif",alarm:"nabu_alarm_dash.gif",countdown:"nabu_countdown_dash.gif",mute:"nabu_mute_dash.gif"},pt=["responding","playing","processing","listening","idle"];class mt extends at{constructor(){super(...arguments),this._countdownActive=!1,this._alarmActive=!1,this._eventUnsubscribes=[]}static async getConfigElement(){return document.createElement("nabu-eyes-dashboard-card-editor")}static getStubConfig(){return{type:"custom:nabu-eyes-dashboard-card",name:"Nabu Eyes",assist_entities:[]}}setConfig(t){if(!t)throw new Error("Invalid configuration.");const e={hide_when_idle:!0,playing_variant:"nabu_playing_dash.gif",media_player_equalizer:"nabu_equalizer_dash.gif",countdown_events:[],countdown_clear_events:[],alarm_events:[],alarm_clear_events:[],alarm_active_states:ht,...t,assist_entities:Array.isArray(t.assist_entities)?[...t.assist_entities]:[]};if(e.assist_entities=(e.assist_entities??[]).map(t=>t?.trim()).filter(t=>!!t?.length),!e.assist_entities.length)throw new Error("You must configure at least one Assist Satellite entity.");e.countdown_events=this._normalizeStringArray(e.countdown_events),e.countdown_clear_events=this._normalizeStringArray(e.countdown_clear_events),e.alarm_events=this._normalizeStringArray(e.alarm_events),e.alarm_clear_events=this._normalizeStringArray(e.alarm_clear_events),e.alarm_entities=this._normalizeStringArray(e.alarm_entities),e.alarm_active_states=this._normalizeStringArray(e.alarm_active_states?.length?e.alarm_active_states:[...ht]),e.playing_variant&&e.playing_variant in ot||(e.playing_variant="nabu_playing_dash.gif"),e.media_player_equalizer&&!(e.media_player_equalizer in lt)&&(e.media_player_equalizer="nabu_equalizer_dash.gif"),this._config=e,this._subscribeToEvents()}_normalizeStringArray(t){return Array.from(new Set((t??[]).map(t=>t?.trim()).filter(t=>!!t?.length)))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeFromEvents()}updated(t){t.has("hass")&&this._subscribeToEvents()}async _subscribeToEvents(){if(this._unsubscribeFromEvents(),!this.hass?.connection||!this._config)return;const t=new Set([...this._config.countdown_events??[],...this._config.countdown_clear_events??[],...this._config.alarm_events??[],...this._config.alarm_clear_events??[]]);if(0!==t.size)for(const e of t)if(e)try{const t=await this.hass.connection.subscribeEvents(t=>{this._handleEvent(e,t.event_type,t.data)},e);this._eventUnsubscribes.push(t)}catch(t){console.warn(`nabu-eyes-dashboard-card: failed to subscribe to event ${e}`,t)}}_unsubscribeFromEvents(){for(;this._eventUnsubscribes.length;){const t=this._eventUnsubscribes.pop();t&&t()}}_handleEvent(t,e,s){if(!this._config)return;if(e!==t)return;const{countdown_events:i=[],countdown_clear_events:n=[],alarm_events:a=[],alarm_clear_events:r=[]}=this._config;i.includes(e)&&(this._countdownActive=!0),n.includes(e)&&(this._countdownActive=!1),a.includes(e)&&(this._alarmActive=!0),r.includes(e)&&(this._alarmActive=!1),s&&Object.prototype.hasOwnProperty.call(s,"active")&&"boolean"==typeof s.active&&((i.includes(e)||n.includes(e))&&(this._countdownActive=s.active),(a.includes(e)||r.includes(e))&&(this._alarmActive=s.active))}getCardSize(){return 3}render(){if(!this._config)return D``;const t=this._determineAsset();return t?D`
      <ha-card>
    ...
    `:D``}_determineAsset(){if(!this._config)return;const t=this._config.asset_path&&this._config.asset_path.trim().length>0?this._config.asset_path:"/local/nabu_eyes_dashboard";if(this._alarmActive||this._isAlarmEntityActive())return this._composeAssetPath(t,ut.alarm);if(this._countdownActive)return this._composeAssetPath(t,ut.countdown);const e=this._computeAssistState();if("playing"===e){const e=this._config.playing_variant??"nabu_playing_dash.gif";return this._composeAssetPath(t,e)}if(e&&"idle"!==e){const s=ut[e];return this._composeAssetPath(t,s)}const s=this._determineMediaPlayerAsset(t);if(s)return s;const i=this._determineMuteAsset(t);if(i)return i;if("idle"===e){if(this._config.hide_when_idle)return;return this._composeAssetPath(t,ut.idle)}return this._config.hide_when_idle?void 0:this._composeAssetPath(t,ut.idle)}_determineMediaPlayerAsset(t){if(!this._config?.media_player||!this.hass)return;const e=this.hass.states[this._config.media_player];if(e&&"playing"===e.state){const e=this._config.media_player_equalizer??"nabu_equalizer_dash.gif",s=lt[e]?e:"nabu_equalizer_dash.gif";return this._composeAssetPath(t,s)}}_determineMuteAsset(t){const e=this._config?.mute_media_player??this._config?.media_player;if(!e||!this.hass)return;const s=this.hass.states[e];if(!s)return;if(!!!s.attributes?.is_volume_muted)return;const i="off"===s.state?"nabu_mute_dash.gif":"nabu_mute_red_dash.gif";return this._composeAssetPath(t,i)}_isAlarmEntityActive(){if(!this._config?.alarm_entities?.length||!this.hass)return!1;const t=this._config.alarm_active_states??ht;return this._config.alarm_entities.some(e=>{const s=this.hass.states[e];return!!s&&t.includes(s.state)})}_composeAssetPath(t,e){return t.endsWith("/")?`${t}${e}`:`${t}/${e}`}_computeAssistState(){if(!this._config?.assist_entities?.length||!this.hass)return;const t=this._config.assist_entities.map(t=>this.hass.states[t]?.state).filter(t=>"string"==typeof t);for(const e of pt)if(t.includes(e))return e}static get styles(){return a`
      ha-card {
        display: flex;
        flex-direction: column;
        align-items: stretch;
    ...
    `}}mt.properties={hass:{attribute:!1},_config:{state:!0},_countdownActive:{state:!0},_alarmActive:{state:!0}};const ft="nabu-eyes-dashboard-card";if(customElements.get(ft)||customElements.define(ft,mt),"undefined"!=typeof window){window.customCards=window.customCards??[];window.customCards.some(t=>t.type===ft)||window.customCards.push({type:ft,name:"Nabu Eyes Dashboard",description:"Animated Assist avatar with media and alarm indicators.",preview:!0})}export{mt as NabuEyesDashboardCard};
